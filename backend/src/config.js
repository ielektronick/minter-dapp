...
const namePrefix = "Arthur Birds Collection";
const description = "Lorem ipsum dolor sit amet";
const baseUri = "ipfs://QmVpAg3vr24vMLq2SBZHG8cPKVYQsggmoF6FenEjCCCf2s"; // This will be replaced automatically
...
const extraMetadata = {
  external_url: "https://arthurbirdz.xyz", // Replace with your website or remove this line if you do not have one.
};
...
const CONTRACT_NAME = "arthurbirdz.xyz";
const CONTRACT_SYMBOL = "ARBZ";
const METADATA_UPDATABLE = true; // set to false if you don't want to allow metadata updates after minting
const OWNER_ADDRESS = "0x8415408356fEA5faC5dAacC091001DA0469B542C";
const TREASURY_ADDRESS = "0x8415408356fEA5faC5dAacC091001DA0469B542C";
